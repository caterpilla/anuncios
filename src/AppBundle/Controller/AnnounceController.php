...
class AnnounceController extends Controller{
    ...
    /**
     * @Route("/{category}", name="announceCategories")
     */
    public function announceCategoryAction($category = null){
    	$categories = $this -> conn -> fetchAll("select name, guid from category");
    ...
    /**
     * @Route("/{category}/{guid}", name="announceSingle")
     */
    ...
    /**
     * @Route("/{id}/anuncios", name="announceMy")
     */
    ...
    /**
     * @Route("/{id}/anuncios/{guid}", name="announceView")
     */
    ...
    /**
     * @Route("/{id}/anuncios/novo", name="announceNew")
     */
    ...
    /**
     * @Route("/{id}/anuncios/{guid}/delete", name="announceDelete")
     */
